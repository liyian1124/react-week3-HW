...
function App() {
  ...
  const handleModalImageChange = (index, value) => {
    setTemplateProduct(prev => {
      ...
      if (value !== "" && index === newImagesUrl.length - 1 && newImagesUrl.length < 5) {
        newImagesUrl.push('');
      }

      if (value === "" && newImagesUrl.length > 1 && newImagesUrl[newImagesUrl.length - 1] === "") {
        newImagesUrl.pop();
      }
        ...
        !isAuth ? (
          <div className="container login">
            <div className="row justify-content-center">
              <h1 className='h3 fw-bold'>請先登入</h1>
              <div className="col-8">
                <form id='form' className='form-signin'>
                  ...
                  <button type="submit" className="btn btn-primary mt-3 w-100" onClick={(e) => loginSubmit(e)}>登入</button>
                </form>
              </div>
            </div>
          </div>
                    ...
                    <tr key={product.id}>
                      ...
                      <td>
                        <div className="btn-group" role="group" aria-label="Basic example">
                          ...
                          <button type="button" className="btn btn-outline-danger btn-sm" onClick={() => openProductModal("delete", product)}>刪除</button>
                        </div>
                      </td>
                    </tr>
                  );
